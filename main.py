...
class score(FloatLayout):
    def __init__(self,):
        ...
        self.btn1 = Button(text='SUBMIT', size_hint=(0.2,0.05), pos_hint={'center_x':0.5, 'center_y':0.5})
        self.add_widget(self.btn1)
    ...
    def submit(self, screen):
        ...
        self.name2 = self.score._get_text().upper()
        self.subject[self.name1.upper()] = self.name2.upper()
...
class result(FloatLayout):
    def __init__(self):
        ...
        background = Image(source='top-view-copy-space.jpg', keep_ratio=False, allow_stretch=True)
        self.add_widget(background)
